import { useStatistics } from "@/app/hooks/statistics";
...
export const FooterComponent = () => {
    ...
    return (
        <footer className="px-4 sm:px-10 py-8 mt-4">
            {hasTotals ? (
                <>
                    <div className="bg-gray-50 p-8 min-h-[350px] rounded shadow-lg flex flex-col items-center justify-center font-sans">
                        <h2 className="text-gray-800 text-3xl font-bold text-center">
                            Nosso site está bombando!
                        </h2>
                        <p className="mb-8">
                            Mais usuários e anunciantes se juntando a cada dia.
                            Faça parte dessa revolução!
                        </p>
                        <div className="grid lg:grid-cols-5 sm:grid-cols-2 gap-6 max-lg:gap-12">
                            <div className="text-center">
                                <h3 className="text-gray-800 text-4xl font-extrabold">
                                    11
                                    <span className="text-blue-600">
                                        {handleTotals(5000000)}+
                                    </span>
                                </h3>
                            ...
                            <div className="text-center">
                                ...
                                <p className="text-sm text-gray-500 mt-2">
                                    Milhares de profissionais já acreditam no
                                    nosso trabalho! Junte-se a eles e impulsione
                                    seu negócio!
                                </p>
                            </div>
                            <div className="text-center">
                                ...
                                <p className="text-sm text-gray-500 mt-2">
                                    The level of user engagement with the
                                    applications content and features.
                                </p>
                            </div>
                            <div className="text-center">
                                <h3 className="text-gray-800 text-4xl font-extrabold">
                                ...
                                <p className="text-sm text-gray-500 mt-2">
                                    The percentage of time the server has been
                    ...
                    >
                        <p className="text-center">
                            Copyright © 2025 Floripa Comercial Todos os direitos
                            reservados.
                        </p>
                    </Link>
                </>
                ...
                <div className="bg-gray-50 text-white py-12 px-4 font-sans tracking-wide">
                    <div className="text-center">
                        ...
                        <div className="text-base text-gray-600">
                            ...
                            >
                                <p className="text-center">
                                    Copyright © 2025 Floripa Comercial Todos os
                                    direitos reservados.
                                </p>
                            </Link>
                        </div>
